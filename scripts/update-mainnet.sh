...
CONTROLLERV1_2_ADDRESS=$(jq -r .address node_modules/@orcaprotocol/contracts/deployments/mainnet/ControllerV1.2.json)
CONTROLLERV1_2_BLOCK=$(jq -r .receipt.blockNumber node_modules/@orcaprotocol/contracts/deployments/mainnet/ControllerV1.2.json)
